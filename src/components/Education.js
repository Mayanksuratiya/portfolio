                ...
                <div className="space-y-8 max-w-3xl mx-auto">
                    {education.map((edu, index) => (
                        ...
                        >
                            ...
                            <div className="bg-transparent bg-white/[0.05] p-6 rounded-2xl shadow-sm border border-white/[0.1]/50 hover:shadow-md transition-shadow">
                                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-2">
                                    <h3 className="text-xl font-bold text-perry-text flex items-center gap-2">
                                        <BookOpen size={20} className="text-blue-500" />
                                        {edu.school}
                                    </h3>
                                    <span className="text-sm font-semibold text-perry-dim bg-white/[0.05] dark:bg-slate-700/50 px-3 py-1 rounded-full mt-2 sm:mt-0">
                                        {edu.year}
                                    </span>
                                </div>
                                <h4 className="text-lg font-medium text-perry-text text-perry-dim mb-2">
                                    {edu.degree}
                                </h4>
